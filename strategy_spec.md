...
|------|------|-------|-----|---------|-------------|--------|----------|-----------------|----------------|
| GBPJPY | ✅ | ✓ | 1.5 | **2** | **2.5** | SL×1.5 | なし | htf4h_rsi_bw (Buy RSI<60/Sell RSI>55, BBwidth>20avg×1.2) | 制限なし |
...
## 6. SMA Squeeze Play (sma_squeeze.py v4.2)

### 概要
SMA200スロープフィルター + SMAスクイーズ解放でトレンドフォロー。v3で日足SMAスロープフィルター追加・COOLDOWN=180分、v4でATR-adaptive trailing stop導入（be_r廃止）、v4.2でtrail_start_multインフラ追加（BT検証により0.0=即時開始が最適と確定）。
...
| ペア | 有効 | TF | SMA短期 | SMA長期 | squeeze_th | slope_period | RR | SL倍率 | atr_trail_mult | trail_start_mult | daily_sma | daily_sp |
|------|------|-----|--------|--------|-----------|-------------|-----|-------|---------------|-----------------|-----------|----------|
| USDJPY | ✅ | 4h | 25 | 150 | 2.0% | 5 | 2.5 | 1.5 | **0.5** | 0.0 | 20 | 3 |
| GBPJPY | ✅ | 1h | 25 | 250 | 0.5% | 10 | 2.0 | 1.5 | **0.5** | 0.0 | 20 | 3 |
| EURUSD | ✅ | 4h | 25 | 200 | 2.0% | 10 | 2.5 | 1.0 | **0.5** | 0.0 | 50 | 3 |
| GBPUSD | ❌ | 1h | 15 | 250 | 1.5% | 20 | 2.0 | 1.0 | 1.5 | 0.0 | 20 | 5 |
| EURJPY | ✅ | 4h | 15 | 150 | 2.0% | 20 | 2.5 | 1.5 | **0.0** (無効) | 0.0 | 20 | 5 |
