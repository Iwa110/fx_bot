...
| ペア | 有効 | JPY系 | σ値 | max_pos | SL倍率(ATR) | TP倍率 | ペア別フィルター | 時間帯制限(UTC) |
|------|------|-------|-----|---------|-------------|--------|-----------------|----------------|
| GBPJPY | ✅ | ✓ | 1.5 | **2** | **2.5** | SL×1.5 | htf4h_rsi_bw (Buy RSI<60/Sell RSI>55, BBwidth>20avg×1.2) | 制限なし |
| USDJPY | ✅ | ✓ | 2.0 | **2** | **2.5** | SL×1.5 | htf4h_rsi_bw (Buy RSI<55/Sell RSI>45, BBwidth>30avg×0.8) | 制限なし |
| EURJPY | ✅ | ✓ | 1.5 | 1 | 2.5 | SL×1.5 | htf4h_only (4h EMA20方向一致のみ) | 9h,17h |
