...
|------|------|-------|-----|-------------|--------|-----------------|----------------|
| GBPJPY | ✅ | ✓ | 1.5 | **2.5** | SL×1.5 | htf4h_rsi_bw (Buy RSI<60/Sell RSI>55, BBwidth>20avg×1.2) | 制限なし |
| USDJPY | ✅ | ✓ | 2.0 | **2.5** | SL×1.5 | htf4h_rsi_bw (Buy RSI<55/Sell RSI>45, BBwidth>30avg×0.8) | 制限なし |
...
## 11. トレーリングストップ共通仕様 (trail_monitor.py v14)
...
### BB_GBPJPY/USDJPY/EURJPY Stage3無効化の根拠（v14, 2026-05-19）
- bb_monitorはH1 ATRでTP設定（SL = H1_ATR × 2.5〜3.0, TP = SL × 1.5 = H1_ATR × 3.75〜4.5）
...
- → stage3_activate=99 でtrail事実上無効化し、TP一本勝負に変更
