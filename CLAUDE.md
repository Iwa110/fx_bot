...
## 最新パフォーマンス統計（自動更新）
<!-- AUTO_STATS_BEGIN -->
更新日時: 2026-05-20 07:10 JST

### 本日 2026-05-20
取引なし

### 直近7日（2026-05-14〜2026-05-20）
総損益: -12,425円  PF=0.485  WR=60.0%  n=15

| ペア | 損益 | PF | WR | n | |
|------|------|----|----|---|---|
| EURJPY | +1,280円 | inf | 100.0% | 1 | ✅ |
| GBPJPY | -11,360円 | 0.332 | 57.1% | 7 | ⚠️ |
| GBPUSD | +4,135円 | 27.171 | 60.0% | 5 | ✅ |
| USDJPY | -6,480円 | 0.072 | 50.0% | 2 | ⚠️ |
...
| 戦略 | 損益 | PF | WR | n |
|------|------|----|----|---|
| BB | -8,367円 | 0.583 | 81.8% | 11 |
| SMA_SQ | -4,058円 | 0.000 | 0.0% | 4 |
...
### 自動アラート
- ⚠️ GBPJPY: PF=0.332（直近7日 n=7）→ パラメータ見直し要
