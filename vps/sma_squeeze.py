...
# ══════════════════════════════════════════
# Config
# NOTE: Update with BT best params after running sma_squeeze_bt.py
#       Use params where PF > 1.2 AND n_trades >= 30 per pair.
# ══════════════════════════════════════════
PAIRS_CFG = {
    'USDJPY': {'sma_short': 20, 'sma_long': 200, 'squeeze_th': 1.0,
               'slope_period': 10, 'rr': 2.0, 'sl_atr_mult': 1.5,
               'timeframe': '1h', 'enabled': True},
    'GBPJPY': {'sma_short': 20, 'sma_long': 200, 'squeeze_th': 1.0,
               'slope_period': 10, 'rr': 2.0, 'sl_atr_mult': 1.5,
               'timeframe': '1h', 'enabled': True},
    'EURUSD': {'sma_short': 20, 'sma_long': 200, 'squeeze_th': 1.0,
               'slope_period': 10, 'rr': 2.0, 'sl_atr_mult': 1.5,
               'timeframe': '1h', 'enabled': True},
    'GBPUSD': {'sma_short': 20, 'sma_long': 200, 'squeeze_th': 1.0,
               'slope_period': 10, 'rr': 2.0, 'sl_atr_mult': 1.5,
               'timeframe': '1h', 'enabled': True},
    'EURJPY': {'sma_short': 20, 'sma_long': 200, 'squeeze_th': 1.0,
               'slope_period': 10, 'rr': 2.0, 'sl_atr_mult': 1.5,
               'timeframe': '1h', 'enabled': True},
}
